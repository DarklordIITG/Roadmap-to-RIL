document.addEventListener("DOMContentLoaded", function () {
  const data = {
    roadmap: [
      {
        ...
        skills: [
          "Initiate MATLAB Proficiency (MATLAB Onramp)",
      ...
      },
      {
        ...
        academic: [
          ...
          "Secondary Goal: Minor project with MATLAB",
        ],
        skills: [
          "Complete AspenTech Learning Path (Beginner/Expert)",
          "Model a simple system (e.g., heat transfer problem)",
        ],
      },
      {
    ...
    projects: [
      ...
      },
      {
        ...
        skills: "Process Design, Aspen Plus, Reaction Engineering, Economics",
        relevance:
      ...
      {
        title: "MATLAB Analysis of Kinetic Data",
        skills: "MATLAB (Optimization), Reaction Kinetics, Numerical Methods",
        relevance:
          "Applicable to optimizing yields in RIL's reactor units. Demonstrates strong analytical and computational skills.",
        star: "Analyzed batch reactor data using MATLAB to determine the reaction rate law. Developed a script to fit data to multiple models, identifying the best-fit model with an R-squared of 0.98.",
      },
    ],
    selectionProcess: [
  ...
  function updateSelectionDetails(stepId) {
    ...
    const container = document.getElementById("selection-details-container");
  ...
  document.querySelectorAll(".selection-step-btn").forEach((btn) => {
    btn.addEventListener("click", () => {
      document.querySelectorAll(".selection-step-btn").forEach((b) => {
        b.classList.remove("bg-[#0d3b66]", "text-white", "border-[#0d3b66]");
  ...
  document.querySelectorAll(".copy-btn").forEach((button) => {
    button.addEventListener("click", (e) => {
      const textToCopy = e.target.closest("div").querySelector("p").innerText;
